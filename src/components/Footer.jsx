...
/**
 * for using this icons here installed some react libraries
 * name are react-icons
 * you can check in dependecies in package.json
 */
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10  w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  ...
                  /> */}
                  <h1 className="text-2xl font-extrabold w-100 animate-pulse">
                    Career Lift
                  </h1>
                  {/* <img
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Empowering Your Career Journey: Explore, Learn, and Grow with
                  Career Lift System.
                </p>
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>+91 6204476413 </span>
                </p>
              </div>
            </div>

            <LinkGroup header="Resources">
              <NavLink link="/AI suggestion" label="AI suggestion" />
            ...
            <LinkGroup header="Company">
              ...
              <NavLink link="/Skill test" label="Skill test" />
              <NavLink link="/About" label="About Career Lift" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-dark dark:text-white animate-pulse">
                  Follow Us On
                </h4>
